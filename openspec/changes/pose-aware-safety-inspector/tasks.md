...
- [ ] 5.1 Rewrite `README.md` to match actual implementation (3-class dataset, preprocessing, dual-model + pose architecture, fine-tuning steps, innovation features, economic sources)
- [ ] 5.2 Remove dead code references (`Mask`/`NO-*`, `Safety Cone`, `Ladder`) while keeping `Fall-Detected`
- [ ] 5.3 Final end-to-end verification via `docker compose up --build`
