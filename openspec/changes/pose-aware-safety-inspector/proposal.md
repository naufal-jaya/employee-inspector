...
- **Fase 2 — Economic risk scoring**: add a deterministic scoring module producing a 0–100 risk score, estimated loss per incident (IDR), and potential savings, sourced from public workplace-safety statistics (BPJS Ketenagakerjaan), surfaced in API response and frontend metrics.
...
- `economic-scoring`: Deterministic compliance risk score (0–100), estimated loss per incident, and potential savings computed from public statistics and exposed in the API response and UI.
